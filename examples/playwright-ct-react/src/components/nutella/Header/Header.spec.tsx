...
test.describe("Header Component with Video Recording", () => {
  ...
  test("header responsive layout", async ({ mount, page }) => {
    ...
    await takeComponentScreenshot(
      component.locator("header").first(),
      page,
      "test-results/header-desktop.png"
    );
    ...
    await takeComponentScreenshot(
      component.locator("header").first(),
      page,
      "test-results/header-tablet.png"
    );
    ...
    await takeComponentScreenshot(
      component.locator("header").first(),
      page,
      "test-results/header-mobile.png"
    );
  ...
  test("main content scrolling with long content", async ({ mount, page }) => {
    ...
    await takeComponentScreenshot(
      component.locator("header").first(),
      page,
      "test-results/header-during-content-scroll.png"
    );
    ...
    await takeComponentScreenshot(
      component.locator("header").first(),
      page,
      "test-results/header-at-bottom.png"
    );
  ...
  test("header visual regression test", async ({ mount, page }) => {
    ...
    await expect(component.locator("header").first()).toHaveScreenshot(
      "header-visual-regression.png"
    );
    ...
    await expect(component.locator("header").first()).toHaveScreenshot(
      "header-scrolled-regression.png"
    );
  });
});
